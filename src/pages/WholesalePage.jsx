...
export default function WholesalePage() {
  ...
  const { data, isFetching } = useQuery({
    queryKey: ["categoryProducts", 36],
    queryFn: () => getAllProductsByCategory(36),
  });
  ...
  return (
    <div className="container my-5">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-gray-400">Wholesale Toys</h1>
        <p className="mt-2 text-gray-600">
          Explore our exclusive wholesale collection of toys and games. Perfect for retailers and
          bulk purchases!
        </p>
      </div>
