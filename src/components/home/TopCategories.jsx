                ...
                <Link to={`/categoryDetail/${category.category_id}`} className="block">
                  <div className="group flex flex-col items-center justify-center rounded-full bg-transparent">
                    <img
                      ...
                      className="mb-2 h-16 w-16 rounded-full object-cover transition-transform group-hover:scale-110 sm:h-24 sm:w-24 md:h-32 md:w-32"
                      loading="lazy"
                    />
                    <h3 className="font-roboto text-center font-bold">{category.name}</h3>
                  </div>
                </Link>
              </div>
            </SwiperSlide>
